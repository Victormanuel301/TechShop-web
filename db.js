...
const productos = [
    ...
    { 
        id: 28,
        nombre: "LED STRIP LIGHTS 15M",
        descripcion: "Tira de luces LED ,  15 metros, con control por aplicación y control remoto de 44 teclas, sincronización de música y temporizador, ideal para decorar el dormitorio, el hogar o fiestas.",
        precio: 4500,
        categoria: "decoracion",
        imagen: img.src = "foto-productos/luces-led.jpg",
        destacado: true
    },
