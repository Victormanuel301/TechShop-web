...
const productos = [
    ...
    { 
        id: 2,
        nombre: "F9-5 TWS",
        descripcion: "Audífonos Inalámbricos TWS F9-5 color blancos con Sonido Estéreo HiFi, Control Táctil, Cancelación de Ruido en Llamadas, Micrófono HD, Diseño Abierto para Oídos, Caja de Carga USB-C.",
        precio: 3000,
        categoria: "audifonos",
        imagen : img.src = "foto-productos/f9b.png",
        destacado: false 
    },
    { 
        id: 3,
        nombre: "Audifonos de Cable",
        descripcion: "Audifonos de cable.",
        precio: 1000,
        categoria: "audifonos",
        imagen : img.src = "foto-productos/audifono-cable.jpg",
        destacado: false 
    },
    /*{ AGOTADO
        id: 2,
    ...
    { 
        id: 5,
        nombre: "Altec Lansing Fury",
        descripcion: "Altec Lansing Fury Potente altavoz inalámbrico: Con una duración de hasta 7 horas de reproducción, resistente al agua,Conectividad Bluetooth",
        precio: 7000,
        categoria: "bocinas",
        imagen : img.src = "foto-productos/bocina-altec.jpg",
        destacado: true
    },
    { 
        id: 6,
        nombre: "Super Bass Speaker",
        descripcion: "modelo ZQS1202",
        precio: 4000 ,
        categoria: "bocinas",
        imagen : img.src = "foto-productos/bocinas.jpg",
        destacado: true
    },
    /*{ AGOTADO
        id: 13,
    ...
    {
        id: 9,
        nombre: "Gran Turismo PS4",
        descripcion: "Disco de play4 Gran Turismo.",
        precio: 1300,
        categoria: "otros",
        imagen: img.src = "foto-productos/discops4.jpeg" ,
        destacado: false
    },
    {
        id: 10,
        nombre: "Funda de Mando PS4",
        descripcion: "Funda para mando de ps4 con 4 fundas de joystick.",
        precio: 1000,
        categoria: "otros",
        imagen: img.src = "foto-productos/funda-mandops4.jpg" ,
        destacado: false
    },
    ...
    },
    {
        id: 14,
        nombre: "EcoFlow ABOK",
        descripcion: "Ecoflou ABOK Batería LIFEPO4,capacidad 1536Wh potencia 2000W, tiempo de carga 1.2h, peso 17.5kg",
        precio:300000,
        categoria: "otros",
        imagen : img.src = "foto-productos/ecoflou.jpg",
        destacado: false 
    },
    { 
        id: 15,
        ...
        precio: 2800,
        categoria: "otros",
        imagen: img.src = "foto-productos/trimer-t9n.jpg",
        destacado: false
    },
    ...
    { 
        ...
        descripcion: "Tira de luces LED , dos rollos 15 metros cada uno ( Total  de 30 m), sin mando, sincronización de música y temporizador, ideal para decorar el dormitorio, el hogar o fiestas.",
        precio: 5500,
        categoria: "decoracion",
        imagen: img.src = "foto-productos/led30m.jpg",
        destacado: true
    },
    ...
    },
    {
        ...
        descripcion: "Estéreo para auto CAMECHO 1DIN con control remoto, audio digital inalámbrico, música, 12V, MP3, USB/SD/AUX-IN, con panel desmontable.",
        precio: 25000,
        categoria: "reproductoras",
        imagen : img.src = "foto-productos/reproductor-mp3.png",
        destacado: false 
    },
    {
        id: 23,
