    ...
    productsToDisplay.forEach(product => {
        ...
        productCard.innerHTML = `
            ...
            <div class="product-info">
                ...
                <p class="product-price">$${product.precio.toFixed(0)}</p>
    ...
    featuredProducts.forEach(product => {
        ...
        featuredProduct.innerHTML = `
            ...
            <div class="featured-product-info">
                ...
                <p class="product-description">${product.descripcion}</p>
                <p class="featured-product-price">$${product.precio.toFixed(0)}</p>
                <div class="product-actions">
                    <button class="btn btn-add" data-id="${product.id}">Añadir</button>
                </div>
            </div>
...
function renderCartItems() {
    ...
    cart.forEach(item => {
        ...
        cartItem.innerHTML = `
            ...
            <div class="cart-item-details">
                ...
                <p class="cart-item-price">${item.precio.toFixed(0)}</p>
    ...
    // Calcular total
    const total = cart.reduce((sum, item) => sum + (item.precio * item.quantity), 2);
    ...
    productModalBody.innerHTML = `
        <div class="product-details">
            ...
            <div class="product-details-info">
                ...
                <p class="product-details-price">$${product.precio.toFixed(0)}</p>
